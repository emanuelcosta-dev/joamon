...
$toemails[] = array(
				'email' => 'info@joamon.pt', // Your Email Address
				'name' => 'Info' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@joamon.pt', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Não responder' // Company Name
			);
...
$mail->SMTPAuth = true;
$mail->Username = "no-reply@joamon.pt";
$mail->Password = 'c3K6h9He';
$mail->Port = 465; //587 gmail-465
...
$message = array(
	'success'			=> 'Recebemos o seu contacto <strong>com sucesso</strong>. Entraremos em contacto com a maior brevidade possível.',
	'error'				=> 'Falha no envio, por favor tente novamente.',
	'error_bot'			=> '',
	'error_unexpected'	=> 'Erro no envio, por favor tente novamente.',
	'recaptcha_invalid'	=> 'Captcha errado! Por favor tente novamente.',
	'recaptcha_error'	=> 'Captcha não confirmado! Por favor tente novamente.'
);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Pedido de Contacto - Website';
	...
	$ar_subject	= !empty( $submits['ar_subject'] ) ? $submits['ar_subject'] : 'Obrigado pelo seu Email';
	$ar_title	= !empty( $submits['ar_title'] ) ? $submits['ar_title'] : 'Agradecemos o seu contacto';
